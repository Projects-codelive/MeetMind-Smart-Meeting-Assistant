          ...
          <div className="p-4 border-t">
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium truncate">Development User</p>
                <p className="text-xs text-gray-500 truncate">Local Mode</p>
              </div>
            </div>
            <Link 
              href="/"
              className="mt-4 w-full flex items-center justify-center space-x-2 px-4 py-2 border rounded-lg hover:bg-gray-100"
            >
